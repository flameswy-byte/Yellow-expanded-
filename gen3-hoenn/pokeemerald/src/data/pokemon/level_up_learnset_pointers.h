const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_LARVESTA] = sSpecies252LevelUpLearnset,
    [SPECIES_VOLCARONA] = sSpecies253LevelUpLearnset,
    [SPECIES_WIMPOD] = sSpecies254LevelUpLearnset,
    [SPECIES_GOLISOPOD] = sSpecies255LevelUpLearnset,
    [SPECIES_VULPIX_A] = sSpecies256LevelUpLearnset,
    [SPECIES_NINETALES_A] = sSpecies257LevelUpLearnset,
    [SPECIES_SLIME] = sSpecies258LevelUpLearnset,
    [SPECIES_METAL_SLIME] = sSpecies259LevelUpLearnset,
    [SPECIES_KING_SLIME] = sSpecies260LevelUpLearnset,
