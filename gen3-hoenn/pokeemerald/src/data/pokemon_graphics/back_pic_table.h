const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(VULPIX_A, gMonBackPic_VulpixA),
    SPECIES_SPRITE(NINETALES_A, gMonBackPic_NinetalesA),
    SPECIES_SPRITE(SLIME, gMonBackPic_Slime),
    SPECIES_SPRITE(METAL_SLIME, gMonBackPic_MetalSlime),
    SPECIES_SPRITE(KING_SLIME, gMonBackPic_KingSlime),
