const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(VULPIX_A, gMonShinyPalette_VulpixA),
    SPECIES_SHINY_PAL(NINETALES_A, gMonShinyPalette_NinetalesA),
    SPECIES_SHINY_PAL(SLIME, gMonShinyPalette_Slime),
    SPECIES_SHINY_PAL(METAL_SLIME, gMonShinyPalette_MetalSlime),
    SPECIES_SHINY_PAL(KING_SLIME, gMonShinyPalette_KingSlime),
