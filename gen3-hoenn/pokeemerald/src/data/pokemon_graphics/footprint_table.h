const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_VULPIX_A] = gMonFootprint_VulpixA,
    [SPECIES_NINETALES_A] = gMonFootprint_NinetalesA,
    [SPECIES_SLIME] = gMonFootprint_Slime,
    [SPECIES_METAL_SLIME] = gMonFootprint_MetalSlime,
    [SPECIES_KING_SLIME] = gMonFootprint_KingSlime,
