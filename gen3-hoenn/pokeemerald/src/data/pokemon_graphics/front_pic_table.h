const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(VULPIX_A, gMonFrontPic_VulpixA),
    SPECIES_SPRITE(NINETALES_A, gMonFrontPic_NinetalesA),
    SPECIES_SPRITE(SLIME, gMonFrontPic_Slime),
    SPECIES_SPRITE(METAL_SLIME, gMonFrontPic_MetalSlime),
    SPECIES_SPRITE(KING_SLIME, gMonFrontPic_KingSlime),
