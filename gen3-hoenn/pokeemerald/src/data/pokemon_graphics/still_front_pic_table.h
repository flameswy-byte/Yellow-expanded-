...
// Empty slots
    ...
    SPECIES_SPRITE(VULPIX_A,   gMonStillFrontPic_VulpixA),
    SPECIES_SPRITE(NINETALES_A,   gMonStillFrontPic_NinetalesA),
    SPECIES_SPRITE(SLIME,   gMonStillFrontPic_Slime),
    SPECIES_SPRITE(METAL_SLIME,   gMonStillFrontPic_MetalSlime),
    SPECIES_SPRITE(KING_SLIME,   gMonStillFrontPic_KingSlime),
