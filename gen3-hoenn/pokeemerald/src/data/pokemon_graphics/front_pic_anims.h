...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_LARVESTA] = sAnims_Wurmple,
    [SPECIES_VOLCARONA] = sAnims_Masquerain,
    [SPECIES_WIMPOD] = sAnims_Anorith,
    [SPECIES_GOLISOPOD] = sAnims_Armaldo,
    [SPECIES_VULPIX_A] = sAnims_Vulpix,
    [SPECIES_NINETALES_A] = sAnims_Ninetales,
    [SPECIES_SLIME] = sAnims_Gulpin,
    [SPECIES_METAL_SLIME] = sAnims_Nosepass,
    [SPECIES_KING_SLIME] = sAnims_Swalot,
