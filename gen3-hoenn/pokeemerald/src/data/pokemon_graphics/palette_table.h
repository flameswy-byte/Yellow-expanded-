const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(VULPIX_A, gMonPalette_VulpixA),
    SPECIES_PAL(NINETALES_A, gMonPalette_NinetalesA),
    SPECIES_PAL(SLIME, gMonPalette_Slime),
    SPECIES_PAL(METAL_SLIME, gMonPalette_MetalSlime),
    SPECIES_PAL(KING_SLIME, gMonPalette_KingSlime),
