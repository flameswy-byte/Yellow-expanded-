...
const u8 gTypeEffectiveness[366] =
{
    ...
    // Fairy, added in Gen 6. Attacking first, then what hits it. The Dragon
    // immunity has to sit above the TYPE_FORESIGHT marker: everything below it
    // is an immunity Foresight and Scrappy can lift, and this one is not.
...
u8 GetWhoStrikesFirst(u8 battler1, u8 battler2, bool8 ignoreChosenMoves)
{
    ...
    if (gBattleMons[battler1].status1 & STATUS1_PARALYSIS)
        speedBattler1 /= PARALYSIS_SPEED_DIVISOR;
    ...
    if (gBattleMons[battler2].status1 & STATUS1_PARALYSIS)
        speedBattler2 /= PARALYSIS_SPEED_DIVISOR;
