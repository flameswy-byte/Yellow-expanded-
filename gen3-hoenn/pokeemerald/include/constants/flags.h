...
#define FLAG_ITEM_ROUTE_137_LIQUID_ORE                              0x28 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x028)
#define FLAG_ITEM_ROUTE_138_X_ACCURACY                              0x29 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x029)
#define FLAG_ITEM_ROUTE_138_MAX_REVIVE                              0x2A // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x02A)
#define FLAG_ITEM_ROUTE_139_ENERGY_ROOT                             0x2B // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x02B)
#define FLAG_ITEM_ROUTE_139_ELIXIR                                  0x2C // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x02C)
#define FLAG_ITEM_ROUTE_139_STAR_PIECE                              0x2D // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x02D)
#define FLAG_ITEM_ROUTE_139_ZINC                                    0x2E // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x02E)
#define FLAG_ITEM_ROUTE_139_HP_UP                                   0x2F // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x02F)
#define FLAG_ITEM_ROUTE_139_LIQUID_ORE                              0x30 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x030)
#define FLAG_ITEM_ROUTE_140_PROTEIN                                 0x31 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x031)
#define FLAG_ITEM_ROUTE_141_CARBOS                                  0x32 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x032)
#define FLAG_ITEM_ROUTE_142_BIG_PEARL                               0x33 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x033)
#define FLAG_ITEM_ROUTE_143_DIRE_HIT                                0x34 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x034)
#define FLAG_ITEM_ROUTE_143_ETHER                                   0x35 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x035)
#define FLAG_ITEM_ROUTE_143_PP_UP                                   0x36 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x036)
#define FLAG_ITEM_ROUTE_143_PROTEIN                                 0x37 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x037)
#define FLAG_ITEM_ROUTE_143_LIQUID_ORE                              0x38 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x038)
#define FLAG_ITEM_ROUTE_144_RARE_CANDY                              0x39 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x039)
#define FLAG_ITEM_ROUTE_144_HYPER_POTION                            0x3A // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x03A)
#define FLAG_ITEM_ROUTE_144_LIQUID_ORE                              0x3B // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x03B)
#define FLAG_ITEM_ROUTE_145_STAR_PIECE                              0x3C // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x03C)
#define FLAG_ITEM_ROUTE_145_LIQUID_ORE                              0x3D // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x03D)
#define FLAG_ITEM_ROUTE_146_IRON                                    0x3E // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x03E)
#define FLAG_ITEM_ROUTE_146_GREAT_BALL                              0x3F // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x03F)
#define FLAG_ITEM_ROUTE_146_MAX_ETHER                               0x40 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x040)
#define FLAG_ITEM_ROUTE_147_CALCIUM                                 0x41 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x041)
#define FLAG_LITTLEROOT_SLIME_TRADED                                0x42 // Open Hoenn - tools/trades.py (FLAG_UNUSED_0x042)
#define FLAG_ITEM_ROUTE_147_X_ACCURACY                              0x43 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x043)
#define FLAG_ITEM_ROUTE_148_ULTRA_BALL                              0x44 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x044)
#define FLAG_ITEM_ROUTE_148_ENERGY_ROOT                             0x45 // Open Hoenn - tools/populate.py (FLAG_UNUSED_0x045)
...
#define FLAG_MET_TM_SWIFT_GIVER          0x76
...
#define FLAG_RECEIVED_TM_SWIFT        0x108
...
#define FLAG_SYS_EXP_SHARE_PARTY                    (SYSTEM_FLAGS + 0x21) // was FLAG_UNUSED_0x881;
                                                                          // Gen 6 party-wide Exp. Share, set when Mr. Stone hands the item over
