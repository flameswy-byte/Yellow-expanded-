...
extern const u32 gMonStillFrontPic_Slime[];
extern const u32 gMonPalette_Slime[];
extern const u32 gMonBackPic_Slime[];
extern const u32 gMonShinyPalette_Slime[];
extern const u32 gMonFrontPic_Slime[];
extern const u8 gMonIcon_Slime[];
extern const u8 gMonFootprint_Slime[];
extern const u32 gMonStillFrontPic_MetalSlime[];
extern const u32 gMonPalette_MetalSlime[];
extern const u32 gMonBackPic_MetalSlime[];
extern const u32 gMonShinyPalette_MetalSlime[];
extern const u32 gMonFrontPic_MetalSlime[];
extern const u8 gMonIcon_MetalSlime[];
extern const u8 gMonFootprint_MetalSlime[];
extern const u32 gMonStillFrontPic_KingSlime[];
extern const u32 gMonPalette_KingSlime[];
extern const u32 gMonBackPic_KingSlime[];
extern const u32 gMonShinyPalette_KingSlime[];
extern const u32 gMonFrontPic_KingSlime[];
extern const u8 gMonIcon_KingSlime[];
extern const u8 gMonFootprint_KingSlime[];
