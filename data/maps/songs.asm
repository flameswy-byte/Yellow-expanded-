MapSongBanks::
	...
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; CELADON_WOODS
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_26
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; ROUTE_27
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; ROUTE_28
